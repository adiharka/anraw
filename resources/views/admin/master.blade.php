...
<head>
    ...
    <style>
        :root {
            --primary: #7a799b;
            --dark: #4d4253;
            --gradient: radial-gradient(100% 2187.83% at 0% 50%, #F9D1AD 0%, #626768 100%);
        }
...
<body>
    <div class="content">
        <div class="navbar">
            <h1>Aula admin</h1>
            <ul>
                <li id='home' onclick="location.href='{{ route('admin.home')}}';" onmouseover="hover('homeLogo')"
                    ...
                    <span>HOME</span></li>
                <li id="kelas" onclick="location.href='{{ route('admin.kelas.index')}}';"
                    onmouseover="hover('kelasLogo')" onmouseout="hover('kelasLogo')">
                    <svg id="kelasLogo" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span>KELAS</span></li>
                <li id="guru" onclick="location.href='{{ route('admin.guru.index')}}';" onmouseover="hover('guruLogo')"
                    onmouseout="hover('guruLogo')">
                    <svg id="guruLogo" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <li id="akun" onclick="location.href='{{ route('admin.akun')}}';" onmouseover="hover('akunLogo')"
